# Generated by Django 5.2b1 on 2025-03-07 22:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('open', 'Abierto'), ('pending', 'Pendiente'), ('closed', 'Cerrado')], default='open', max_length=20, verbose_name='Estado')),
